...
PropUnc2100=load('../../Data/WithPopChange/ProportionOfUncertainty/PropUnc2100_SSP2').PropUnc2100;
...
caxis([0,1])
set(c,'YTick',0:0.1:1)
c.Label.String='Proportion of uncertainty in $R_{0}$ from natural climate variability in 2100';
c.FontSize=14;
x1=get(gca,'position');
...
exportgraphics(gcf,'FigureS18A.pdf')
...
myColorMap=[225/256,110/256,224/256;1,1,1;30/256,145/256,31/256];
...
c.Label.String='Dominant source of uncertainty in the $R_{0}$ of dengue in 2100';
c.FontSize=14;
x1=get(gca,'position');
colorbarpos=c.Position;
colorbarpos(4)=colorbarpos(4)*0.5;
...
exportgraphics(gcf,'FigureS18B.pdf')

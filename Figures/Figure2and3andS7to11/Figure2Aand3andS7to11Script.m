...
load("../../Data/WithPopChange/R0_SSP3/SuitabilityStatistics/suitability_2100.mat")
...
exportgraphics(gcf,'FigureS8C.pdf')
...
exportgraphics(gcf,'FigureS8B.pdf')
...
exportgraphics(gcf,'FigureS8A.pdf')
...
exportgraphics(gcf,'FigureS10C.pdf')
...
exportgraphics(gcf,'FigureS10B.pdf')
...
exportgraphics(gcf,'FigureS10A.pdf')
...
exportgraphics(gcf,'FigureS9C.pdf')
...
exportgraphics(gcf,'FigureS9B.pdf')
...
exportgraphics(gcf,'FigureS9A.pdf')
...
exportgraphics(gcf,'FigureS11C.pdf')
...
exportgraphics(gcf,'FigureS11B.pdf')
...
exportgraphics(gcf,'FigureS11A.pdf')
...
exportgraphics(gcf,'Figure2A.pdf')
...
exportgraphics(gcf,'Figure3B.pdf')
...
exportgraphics(gcf,'Figure3A.pdf')
...
exportgraphics(gcf,'FigureS7.pdf')
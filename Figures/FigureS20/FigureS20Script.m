...
R0g0_2100_all=load("../../Data/WithPopChange/PopulationAtRisk_SSP2/pop_at_risk_2100_all_sims.mat").mat_pop_at_risk_R00;
R0g0_2100_all=R0g0_2100_all(:,end-11:end);
R0g1_2100_all=load("../../Data/WithPopChange/PopulationAtRisk_SSP2/pop_at_risk_2100_all_sims.mat").mat_pop_at_risk_R01;
...
exportgraphics(gcf,'FigureS20B.pdf')
...
exportgraphics(gcf,'FigureS20A.pdf')

...
avg_suitability_2100=load("../../Data/WithoutPopChange/R0_SSP3/SuitabilityStatistics/suitability_2100.mat").avg_suitability_2100;
...
avg_suitability_2100=avg_suitability_2100.*pop2020;
...
c.Label.String='Change in number of months suitable for sustained transmission of dengue';
c.FontSize=14;
x1=get(gca,'position');
...
exportgraphics(gcf,'FigureS6.pdf')

...
R0MedianMat=zeros(288,192,36);
R0SmallestMat=zeros(288,192,36);
R0BiggestMat=zeros(288,192,36);
...
save(strcat('Data/R0WithoutPop/GlobalR0WithoutPopChangeAvgBigSmal/R0Sim',num2str(p)),'R0MedianMat','R0SmallestMat','R0BiggestMat')
